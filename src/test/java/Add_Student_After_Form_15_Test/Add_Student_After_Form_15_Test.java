package Add_Student_After_Form_15_Test;
...
public class Add_Student_After_Form_15_Test extends Achievement_Charter_Excel_Data_BaseClass
{
	int TCID;
	Pom_classes.Login_Pom login;
	Add_Student_After_Form_15_Pom.Home_Page_Pom Home_Page;
	...
	public void OpenBrowser(String browsername) throws InterruptedException
	{
		...
		Home_Page = new Add_Student_After_Form_15_Pom.Home_Page_Pom(driver);
	...
	@Test
	public void Add_student_After_Form_15() throws InterruptedException, EncryptedDocumentException, IOException
	{
		Thread.sleep(2000);
