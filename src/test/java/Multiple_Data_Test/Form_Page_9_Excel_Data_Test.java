...
import Multiple_data_POM.Form_Page_9_Excel_Data_Pom;
import Pom_classes.Form_Page_1_Pom;
import Pom_classes.Home_Page_Pom;

public class Form_Page_9_Excel_Data_Test extends Achievement_Charter_Excel_Data_BaseClass
{
	...
	Form_Page_9_Excel_Data_Pom Form9;
	...
	public void OpenBrowser(String browsername) throws InterruptedException
	{
		...
		Form9 = new Form_Page_9_Excel_Data_Pom(driver);
	}
		
		
		@Test
		public void Verify_Guardian_Name_Field() throws EncryptedDocumentException, InterruptedException, IOException
		{
			...
			Form9.Set_Guardian_Name(driver);
			
		}
		
		
		@Test
		public void Verify_Student_Language_Field() throws InterruptedException, EncryptedDocumentException, IOException
		{
			login.login(Utility.getdata(1, 1), Utility.getdata(2, 1));
			...
			Form9.Set_Student_Language(driver);
