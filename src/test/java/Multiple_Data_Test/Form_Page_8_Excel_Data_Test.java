...
import Multiple_data_POM.Form_Page_8_Excel_Data_Pom;
import Pom_classes.Form_Page_1_Pom;
import Pom_classes.Home_Page_Pom;

public class Form_Page_8_Excel_Data_Test extends Achievement_Charter_Excel_Data_BaseClass
{
	...
	Form_Page_8_Excel_Data_Pom Form8;
	...
	public void OpenBrowser(String browsername) throws InterruptedException
	{
		...
		Form8 = new Form_Page_8_Excel_Data_Pom(driver);
		...
		@Test
		public void Verify_Case_Number_Field() throws InterruptedException, EncryptedDocumentException, IOException
		{
			login.login(Utility.getdata(1, 1), Utility.getdata(2, 1));
