...
import Multiple_data_POM.Form_Page_11_Excel_Data_Pom;
import Pom_classes.Form_Page_1_Pom;
import Pom_classes.Home_Page_Pom;

public class Form_Page_11_Excel_Data_Test extends Achievement_Charter_Excel_Data_BaseClass
{
	...
	Form_Page_11_Excel_Data_Pom Form11; 
	...
	public void OpenBrowser(String browsername) throws InterruptedException
	{
		...
		Form11 = new Form_Page_11_Excel_Data_Pom(driver);
	}
		
		
		
		@Test
		public void Verify_Service_Provider_Field() throws EncryptedDocumentException, InterruptedException, IOException
		{
			...
			Form11.Set_Service_Provider(driver);
		...
		@Test
		public void Verify_Internet_Speed_Field() throws InterruptedException, EncryptedDocumentException, IOException
		{
			login.login(Utility.getdata(1, 1), Utility.getdata(2, 1));
			...
			Form11.Set_Internet_Speed(driver);
			
			Form11.Set_Internet_access(driver);
			
		}
		
		@Test
		public void Verify_Internet_access_Field() throws InterruptedException, EncryptedDocumentException, IOException
		{
			login.login(Utility.getdata(1, 1), Utility.getdata(2, 1));
