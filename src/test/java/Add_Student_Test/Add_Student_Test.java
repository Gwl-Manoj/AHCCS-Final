...
import Pom_classes.Home_Page_Add_Student_Pom;

public class Add_Student_Test extends Achievement_Charter_Excel_Data_BaseClass
{

	int TCID;
	Pom_classes.Login_Pom login;
	Home_Page_Add_Student_Pom Home_Page;
	...
	public void OpenBrowser(String browsername) throws InterruptedException
	{
		...
		Home_Page = new Home_Page_Add_Student_Pom(driver);
	...
	@Test
	public void Add_Student_Home_Page() throws InterruptedException, EncryptedDocumentException, IOException
	{
