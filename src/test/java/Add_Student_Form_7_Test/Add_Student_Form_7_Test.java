package Add_Student_Form_7_Test;
...
import Add_Student_Form_7_Pom.Form_Page_7_Pom;
import Library_Files.Achievement_Charter_Excel_Data_BaseClass;
import Library_Files.Utility;
import Pom_classes.Form_Page_1_Pom;

public class Add_Student_Form_7_Test extends Achievement_Charter_Excel_Data_BaseClass
{
	...
	Pom_classes.Form_Page_14_Pom Form14;
	Pom_classes.Form_Page_15_Pom Form15;
	...
	public void OpenBrowser(String browsername) throws InterruptedException
	{
		...
		Form14 = new Pom_classes.Form_Page_14_Pom(driver);
		Form15 = new Pom_classes.Form_Page_15_Pom(driver);
	...
	@Test
	public void Add_Student_After_Form_Page_7() throws InterruptedException, EncryptedDocumentException, IOException
	{
		...
		Form7.Fill_Form_Page_7(driver, Utility.getdata(45,1), Utility.getdata(46,1));
		...
		Form15.Fill_Form_Page_15(driver);
	}
