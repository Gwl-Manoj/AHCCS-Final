...
public class Form_Pom
{
	...
	public Form_Pom(WebDriver driver)
	{
...
//		CheckBox.click();
	...
	public void Click_Save_Your_Progress_Btn() throws InterruptedException
	{
		...
		Reporter.log("The Progress is saved of Form Page 1 --> "+message,true);
		Reporter.log("	",true);
	...
	public void Fill_Form_Page_1(WebDriver driver, String fname, String Pname, String Lname, String MiddleName, String H_address, String city,String zipcode, String Mailing_Address, String Mailing_city, String Mailing_zipcode, String s_phone, String s_mail   ) throws InterruptedException, EncryptedDocumentException, IOException
	{
