package Add_Student_Form_7_Pom;
...
public class Form_Page_7_Pom 
{
	...
	public void Fill_Form_Page_7(WebDriver driver, String S_name, String S_name1) throws InterruptedException, EncryptedDocumentException, IOException
	{
		...
		Click_Add_Student_Button(driver);
		
		Set_Student_Name1(S_name1);
